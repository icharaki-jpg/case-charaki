...
export default function CaseDetailsPage() {
  ...
  return <AuthGate><div className="page-shell narrow"><div className="page-header"><div><p className="eyebrow">جزئیات پرونده</p><h1>{toPersianDigits(item.caseNumber)}</h1></div><Link href="/cases" className="button button-secondary">بازگشت</Link></div>
